...
evaluate_model(y_test[1:], y_pred_lstm.flatten(), "LSTM") # activity : Check the code for LSTM
...
# changed data size so that y_test and y_pred is the same in related LSTM 
